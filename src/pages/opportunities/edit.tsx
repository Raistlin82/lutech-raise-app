...
import { ArrowLeft, Save, Building2, DollarSign, Briefcase, AlertCircle, Lock, Plus, Layers, Trash2 } from 'lucide-react';
...
export const EditOpportunityPage = () => {
    ...
    useEffect(() => {
        if (existingOpp) {
            ...
            // Initialize Multi-Lot data
            setIsMultiLot(!!existingOpp.isMultiLot);
            setAreLotsMutuallyExclusive(!!existingOpp.areLotsMutuallyExclusive);
            if (existingOpp.lots && existingOpp.lots.length > 0) {
                setLots(existingOpp.lots.map(l => ({
                    id: l.id,
                    name: l.name,
                    tcv: l.tcv.toString(),
                    raiseTcv: l.raiseTcv.toString(),
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const updatedOpp: Opportunity = {
                ...
                isFastTrack: finalTcv < 250000 && !formData.hasKcpDeviations,
                ...
                lots: isMultiLot ? finalLots : undefined,
            };
                ...
                <div className="space-y-4 pt-6 border-t border-slate-200">
                    <div className="flex items-center justify-between">
                        <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2">
                            ...
                            {t('new.sectionLots', 'Gestione Lotti')}
                        </h2>
